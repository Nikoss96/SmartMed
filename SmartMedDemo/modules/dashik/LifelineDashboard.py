...
def curve(self, dis, status, distance2, status2, number, about, inz):
    ...
    if number == 2:
        fig.add_trace(
            go.Scatter(
                x=kmf2.survival_function_.index,
                y=kmf2.survival_function_["KM_estimate"],
...
def longlife_table(self, n, distance, status):
    ...
    kmf = KaplanMeierFitter()
    table = survival_table_from_events(
        distance, status, intervals=inters, collapse=False
    )
    ...
    table.rename(
        columns={
            "at_risk": "Число в начале",
            "censored": "Число изъятых",
            "learning": "Число изучаемых",
            "observed": "Число умерших",
            "died": "Доля умерших",
            "alive": "Доля выживших",
            "removed": "Число в конце",
        },
        inplace=True,
    )
...
class LifelineDashboard(Dashboard):
    def _generate_layout(self):
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Анализ Выживаемости"),
                    style={"text-align": "center"},
                ),
                dcc.Markdown(
                    children=lidea, style={"text-align": "center", "padding": "20px"}
                ),
                html.Div(met_list),
            ]
        )
    ...
    def _comare(self):
        return html.Div(
            [
                html.Div(
                    html.H2(children="Сравнение выживаемости в двух выборках"),
                    style={"text-align": "center"},
                ),
                dcc.Markdown(
                    children=lcompare, style={"text-align": "center", "padding": "20px"}
                ),
            ]
        )
    ...
    def _generate_c1(self):
        ...
        return html.Div(
            [
                html.Div(
                    html.H2(children="Логарифмический ранговый критерий"),
                    style={"text-align": "center"},
                ),
                dcc.Markdown(
                    children=llog, style={"text-align": "center", "padding": "20px"}
                ),
                html.Div(
                    [
    ...
    def _generate_c2(self):
        ...
        return html.Div(
            [
                html.Div(
                    html.H2(children="Критерий Гехана-Вилкоксона"),
                    style={"text-align": "center"},
                ),
                dcc.Markdown(
                    children=lwil, style={"text-align": "center", "padding": "20px"}
                ),
                html.Div(
                    [
                        dcc.Markdown(children="Выберите группирующую переменную"),
    ...
    def _generate_table2(self):
        ...
        def update_output_div(n, name1):
            ...
            return html.Div(
                [
                    html.Div(
                        html.H2(children="Таблица времен жизни 1 группы"),
                        style={"text-align": "center"},
                    ),
                    html.Div(
                        [
                    ...
                    html.Div(
                        html.H2(children="Таблица времен жизни 2 группы"),
                        style={"text-align": "center"},
                    ),
                    html.Div(
                        [
        ...
        self.app.callback(
            Output("tab1", "children"), [Input("n", "value"), Input("name1", "value")]
        )(update_output_div)
        cols = []
        for i in df.columns:
            if len(df[i].unique()) == 2:
        ...
        return html.Div(
            [
                html.Div(
                    [
                        html.Div(
                            html.H1(children="Таблицы времен жизни"),
                            style={"text-align": "center"},
                        ),
                        dcc.Markdown(
                            children=ltab,
    ...
    def _generate_curve2(self):
        ...
        self.app.callback(
            ...
            [Input("m", "value"), Input("inz", "value"), Input("name2", "value")],
        )(update_output_div)
        cols = []
        for i in df.columns:
            if len(df[i].unique()) == 2:
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Оценки Каплана-Мейера"),
                    style={"text-align": "center"},
                ),
                dcc.Markdown(
                    children=lmarks, style={"text-align": "center", "padding": "20px"}
                ),
                html.Div(
                    [
                        html.Div(
                            html.H2(children="Кривые выживаемости"),
                            style={"text-align": "center"},
                        ),
    ...
    def _generate_median(self):
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Медиана выживаемости"),
                    style={"text-align": "center"},
                ),
                dcc.Markdown(
                    children=lmedian, style={"text-align": "center", "padding": "20px"}
                ),
                html.Div(
                    [
                        html.Div(
    ...
    def _generate_table(self):
        def update_output_div(n):
            ...
            return html.Div(
                [
                    html.Div(
                        html.H2(children="Таблица времен жизни"),
                        style={"text-align": "center"},
                    ),
                    dcc.Markdown(
                        children=ltab, style={"text-align": "center", "padding": "20px"}
                    ),
                    html.Div(
                        [
                            html.Div(
        ...
        self.app.callback(Output("tab2", "children"), [Input("h", "value")])(
            update_output_div
        )
        return html.Div(
            [
    ...
    def _generate_curve(self):
        ...
        self.app.callback(
            ...
            [Input("k", "value"), Input("inz2", "value")],
        )(update_output_div)
        return html.Div(
            [
                html.Div(
                ...
                html.Div(
                    [
                        html.Div(
                            html.H2(children="Кривая выживаемости"),
                            style={"text-align": "center"},
                        ),
                        dcc.Markdown(
                            children=lcurve,
    ...
    def _generate_median2(self):
        ...
        def update_output_div(name12):
            ...
            med2 = cd._median
            d = {
                "Значение медианы 1": pd.Series(med1),
                "Значение медианы 2": pd.Series(med2),
            }
            df2 = pd.DataFrame(d)
            return html.Div(
                [
