...
class StatisticsDashboard(Dashboard):
    ...
    def _generate_table(self, max_rows=10):
        ...
        if len(df.columns) <= 5:
            return html.Div(
                [
                    html.Div(
                        html.H1(children="Описательная таблица"),
    ...
    def _generate_linear(self):
        ...
        self.app.callback(
            dash.dependencies.Output("linear_graph", "figure"),
            [
                dash.dependencies.Input("xaxis_column_name", "value"),
                dash.dependencies.Input("yaxis_column_name", "value"),
            ],
        )(update_graph)
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Линейный график"), style={"text-align": "center"}
                ),
                html.Div(
                    [
                        html.Div(
                ...
                html.Div(
                    dcc.Markdown(children=markdown_text_lin),
    ...
    def _generate_scatter(self):
        ...
        self.app.callback(
            dash.dependencies.Output("scatter_matrix", "figure"),
            dash.dependencies.Input("possible_columns", "value"),
        ...
        return html.Div(
            [
                ...
                html.Div(
                    html.H1(children="Матрица рассеяния"),
                    style={"text-align": "center"},
                ),
                html.Div(
                    [
                        ...
                        html.Div(
                            dcc.Markdown(children=markdown_text_scatter),
                            style={
                                "width": "18%",
                                "float": "right",
                                "display": "inline-block",
    ...
    def _generate_heatmap(self):
        ...
        return html.Div(
            [
                html.Div(html.H1(children="Хитмап"), style={"text-align": "center"}),
                html.Div(
                    [
                        html.Div(
                        ...
                        html.Div(
                            dcc.Markdown(children=markdown_text_heatmap),
                            style={
                                "width": "18%",
                                "float": "right",
                                "display": "inline-block",
    ...
    def _generate_corr(self, max_rows=10):
        ...
        if len(df.columns) <= 5:
            return html.Div(
                [
                    html.Div(
                        html.H1(children="Таблица корреляций"),
                        style={"text-align": "center"},
                    ),
                    html.Div(
                        [
    ...
    def _generate_box(self):
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Ящик с усами"), style={"text-align": "center"}
                ),
                html.Div(
                    [
                        html.Div(
                            dcc.Graph(id="box", figure=fig),
                            style={
                                "width": "78%",
                                "display": "inline-block",
                                "border-color": "rgb(220, 220, 220)",
    ...
    def _generate_hist(self):
        def update_hist(xaxis_column_name_hist):
            ...
            fig = go.Figure(
                data=go.Histogram(
                    x=self.pp.get_numeric_df(self.settings["data"])[
                        xaxis_column_name_hist
                    ]
                )
            )
        ...
        self.app.callback(
            ...
            dash.dependencies.Input("xaxis_column_name_hist", "value"),
        )(update_hist)
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Гистограмма"), style={"text-align": "center"}
                ),
                html.Div(
                    [
    ...
    def _generate_log(self):
        def update_graph(
            xaxis_column_name_log,
            yaxis_column_name_log,
        ):
            fig = px.scatter(
                self.settings["data"], x=xaxis_column_name_log, y=yaxis_column_name_log
            )
            fig.update_xaxes(title=xaxis_column_name_log, type="log")
            fig.update_yaxes(title=yaxis_column_name_log, type="log")

            return fig

        self.app.callback(
            dash.dependencies.Output("log_graph", "figure"),
            [
                dash.dependencies.Input("xaxis_column_name_log", "value"),
                dash.dependencies.Input("yaxis_column_name_log", "value"),
            ],
        )(update_graph)
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Логарифмический график"),
                    style={"text-align": "center"},
                ),
                html.Div(
                    [
                ...
                html.Div(
                    dcc.Markdown(children=markdown_text_log),
                    style={"width": "18%", "float": "right", "display": "inline-block"},
                ),
            ],
            style={"margin": "100px"},
    ...
    def _generate_linlog(self):
        def update_graph(
            xaxis_column_name_linlog,
            yaxis_column_name_linlog,
            xaxis_type_linlog,
            yaxis_type_linlog,
        ):
            fig = px.scatter(
                self.settings["data"],
                x=xaxis_column_name_linlog,
                y=yaxis_column_name_linlog,
            )
            fig.update_xaxes(
                title=xaxis_column_name_linlog,
                type="linear" if xaxis_type_linlog == "Linear" else "log",
            )
            fig.update_yaxes(
                title=yaxis_column_name_linlog,
        ...
        self.app.callback(
            dash.dependencies.Output("linlog_graph", "figure"),
            [
            ...
            dash.dependencies.Input("yaxis_type_linlog", "value"),
        )(update_graph)
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Линейный/логарифмический график"),
                    style={"text-align": "center"},
                ),
                html.Div(
                    [
                ...
                html.Div(
                    dcc.Markdown(children=markdown_text_linlog),
                    style={"width": "18%", "float": "right", "display": "inline-block"},
                ),
            ],
            style={"margin": "100px"},
    ...
    def _generate_piechart(self):
        ...
        def update_pie(xaxis_column_name_pie):
            ...
            fig = px.pie(df, values=df_counts, names=df_unique)
        ...
        self.app.callback(
            ...
            dash.dependencies.Input("xaxis_column_name_pie", "value"),
        )(update_pie)
        ...
        if df.size > 0:
            return html.Div(
                [
                    html.Div(
                        html.H1(children="Круговая диаграмма"),
                        style={"text-align": "center"},
                    ),
                    html.Div(
                        [
    ...
    def _generate_dotplot(self):
        ...
        fig.update_layout(title="Dot Plot", xaxis_title="Value", yaxis_title="Number")
        ...
        self.app.callback(
            ...
            dash.dependencies.Input("yaxis_column_name_dotplot", "value"),
        )(update_dot)
        ...
        if df_cat.size > 0:
            return html.Div(
                [
                    html.Div(
                        html.H1(children="Точечная диаграмма"),
                        style={"text-align": "center"},
                    ),
                    html.Div(
                        [
    ...
    def _generate_box_hist(self):
        ...
        def update_hist(xaxis_column_name_box_hist):
            fig_hist = px.histogram(self.settings["data"], x=xaxis_column_name_box_hist)
        ...
        self.app.callback(
            dash.dependencies.Output("Histogram_boxhist", "figure"),
            dash.dependencies.Input("xaxis_column_name_box_hist", "value"),
        )(update_hist)

        def update_box(xaxis_column_name_box_hist):
            fig_box = px.box(self.settings["data"], x=xaxis_column_name_box_hist)
            fig_box.update_xaxes(title=xaxis_column_name_box_hist)
            return fig_box

        self.app.callback(
            dash.dependencies.Output("Box_boxhist", "figure"),
            dash.dependencies.Input("xaxis_column_name_box_hist", "value"),
        )(update_box)
        ...
        return html.Div(
            [
                html.Div(
                    html.H1(children="Гистограмма и ящик с усами"),
                    style={"text-align": "center"},
                ),
                html.Div(
                    [
    ...
    def _generate_multi_hist(self):
        ...
        self.app.callback(
            dash.dependencies.Output("Histogram_multi_hist", "figure"),
            dash.dependencies.Input("xaxis_chosen_fearures_multi_hist", "value"),
            dash.dependencies.Input("nbins_multi_hist", "value"),
        )(update_multi_hist)
        ...
        self.app.callback(
            dash.dependencies.Output("xaxis_chosen_fearures_multi_hist", "options"),
            dash.dependencies.Input("xaxis_features_multi_hist", "value"),
        )(update_dropdown_milti_hist)

        return html.Div(
            [
                html.Div(
                    html.H1(children="Множественная гистограмма"),
                    style={"text-align": "center"},
                ),
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Markdown(children="Выберите показатель:"),
                                dcc.Dropdown(
                                    id="xaxis_chosen_fearures_multi_hist", multi=True
                                ),
                            ],
                            style={
                                "width": "48%",
                        ...
                        html.Div(
                            [dcc.Graph(id="Histogram_multi_hist")],
                            style={"width": "100%", "display": "inline-block"},
                        ),
                    ],
                    style={
